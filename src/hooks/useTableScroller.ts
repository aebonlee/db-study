...
const useTableScroller = (): void => {
  useEffect(() => {
    const createArrow = (direction: 'left' | 'right'): HTMLButtonElement => {
    ...
    const addScrollControls = (scrollEl: HTMLElement, arrowParent: HTMLElement): void => {
