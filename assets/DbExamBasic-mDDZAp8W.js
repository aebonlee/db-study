import{r,j as e}from"./index-B7RmXR7j.js";import{u as V}from"./useAOS-Bim3vAHH.js";const c=[{id:1,type:"multiple",cat:"A형",pts:2,q:"다음 중 DBMS 필수 기능이 아닌 것은?",opts:["A. 정의","B. 조작","C. 제어","D. 연산"],ans:"D",exp:"DBMS의 3대 기능은 정의(DDL), 조작(DML), 제어(DCL)입니다. 연산은 별도 기능이 아닙니다.",guide:`DBMS 3대 기능:
...
• REVOKE 권한 ON 객체 FROM 사용자;
  → 권한 회수
→ 두 명령어를 함께 작성`}],O=3600,H=["A형","B형","C형"];function J(n,m){if(!m||!m.trim())return 0;if(n.type==="multiple")return m===n.ans?n.pts:0;const x=n.ans.replace(/[.,;:!?()]/g," ").split(/\s+/).filter(i=>i.length>=2),T=m.toLowerCase(),o=x.filter(i=>T.includes(i.toLowerCase())).length/x.length;return o>=.7?n.pts:o>=.4?Math.round(n.pts*.7):o>=.2?Math.round(n.pts*.4):0}const Y=()=>{V();const[n,m]=r.useState("intro"),[x,T]=r.useState(""),[t,o]=r.useState(0),[i,L]=r.useState({}),[j,D]=r.useState(O),[w,y]=r.useState(null),[U,S]=r.useState(!1),[b,v]=r.useState("A형"),A=r.useRef(null);r.useEffect(()=>{if(n==="exam")return A.current=setInterval(()=>{D(s=>s<=1?(clearInterval(A.current),0):s-1)},1e3),()=>clearInterval(A.current)},[n]),r.useEffect(()=>{n==="exam"&&j===0&&q()},[j,n]);const f=s=>`${String(Math.floor(s/60)).padStart(2,"0")}:${String(s%60).padStart(2,"0")}`,I=()=>{x.trim()&&m("exam")},B=r.useCallback(s=>{L(l=>({...l,[t]:s}))},[t]),C=()=>Object.keys(i).filter(s=>i[s]!==""&&i[s]!==void 0).length,q=()=>{clearInterval(A.current);let s=0;const l={};H.forEach(d=>{l[d]={s:0,t:0}}),c.forEach(d=>{l[d.cat].t+=d.pts});const N=c.map((d,a)=>{const h=J(d,i[a]);return s+=h,l[d.cat].s+=h,{...d,userAns:i[a]||"",score:h}});y({total:s,cats:l,details:N,student:x,time:O-j}),m("result"),S(!1)},F=()=>{L({}),o(0),D(O),y(null),m("intro"),v("A형")};if(n==="intro")return e.jsxs(e.Fragment,{children:[e.jsx("section",{className:"page-header",children:e.jsxs("div",{className:"container",children:[e.jsx("h1",{children:"DB 초급테스트"}),e.jsx("p",{children:"데이터베이스 종합 실력 평가 — 26문제, 100점 만점, 60분"})]})}),e.jsx("section",{className:"section",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"exam-intro","data-aos":"fade-up",children:[e.jsxs("div",{className:"exam-info-grid",children:[e.jsxs("div",{className:"exam-info-card",children:[e.jsx("span",{className:"exam-info-icon",children:"✓"}),e.jsx("strong",{children:"A형 — 객관·단답"}),e.jsx("span",{children:"10문제 · 20점"})]}),e.jsxs("div",{className:"exam-info-card",children:[e.jsx("span",{className:"exam-info-icon",children:"✍"}),e.jsx("strong",{children:"B형 — 서술·개념"}),e.jsx("span",{children:"8문제 · 40점"})]}),e.jsxs("div",{className:"exam-info-card",children:[e.jsx("span",{className:"exam-info-icon",children:"💻"}),e.jsx("strong",{children:"C형 — SQL 실기"}),e.jsx("span",{children:"8문제 · 40점"})]}),e.jsxs("div",{className:"exam-info-card",children:[e.jsx("span",{className:"exam-info-icon",children:"⏱"}),e.jsx("strong",{children:"제한시간"}),e.jsx("span",{children:"60분"})]})]}),e.jsxs("div",{className:"exam-notice",children:[e.jsx("h3",{children:"시험 안내"}),e.jsxs("ul",{children:[e.jsx("li",{children:"A형(객관식/단답) 10문항, B형(서술) 8문항, C형(SQL) 8문항으로 구성됩니다."}),e.jsx("li",{children:"서술형/SQL 문제는 키워드 기반으로 채점됩니다."}),e.jsx("li",{children:"시험 시간은 60분이며, 시간 초과 시 자동 제출됩니다."}),e.jsx("li",{children:"문제를 풀면서 학습 가이드를 참고할 수 있습니다."})]})]}),e.jsxs("div",{className:"exam-start-form",children:[e.jsx("input",{type:"text",placeholder:"이름을 입력하세요",value:x,onChange:s=>T(s.target.value),onKeyDown:s=>s.key==="Enter"&&I(),className:"exam-name-input"}),e.jsx("button",{onClick:I,className:"exam-start-btn",disabled:!x.trim(),children:"시험 시작"})]})]})})})]});if(n==="exam"){const s=c[t],l=c.filter(a=>a.cat==="A형"),N=c.filter(a=>a.cat==="B형"),d=c.filter(a=>a.cat==="C형");return e.jsxs(e.Fragment,{children:[e.jsx("section",{className:"page-header exam-header-bar",children:e.jsxs("div",{className:"container exam-top-bar",children:[e.jsx("span",{className:"exam-student",children:x}),e.jsxs("span",{className:"exam-progress-text",children:[C()," / ",c.length," 답변"]}),e.jsx("span",{className:`exam-timer ${j<=300?"exam-timer--warn":""}`,children:f(j)})]})}),e.jsx("section",{className:"section",children:e.jsxs("div",{className:"container",children:[e.jsxs("div",{className:"exam-sidebar-layout",children:[e.jsxs("div",{className:"exam-sidebar",children:[[{label:"A형 객관·단답 (1-10)",qs:l,offset:0},{label:"B형 서술 (11-18)",qs:N,offset:10},{label:"C형 SQL (19-26)",qs:d,offset:18}].map(({label:a,qs:h,offset:E})=>e.jsxs("div",{className:"exam-nav-section",children:[e.jsx("h4",{children:a}),e.jsx("div",{className:"exam-nav-buttons",children:h.map((M,G)=>{const u=E+G,K=i[u]!==void 0&&i[u]!=="";return e.jsx("button",{className:`exam-nav-btn ${u===t?"exam-nav-btn--cur":""} ${K?"exam-nav-btn--done":""}`,onClick:()=>o(u),children:u+1},u)})})]},a)),e.jsxs("div",{className:"exam-score-tracker",children:[e.jsx("h4",{children:"진행 현황"}),e.jsxs("div",{className:"exam-live-score",children:[C(),e.jsxs("span",{children:[" / ",c.length]})]}),e.jsx("div",{className:"exam-progress-track",children:e.jsx("div",{className:"exam-progress-fill",style:{width:`${C()/c.length*100}%`}})})]})]}),e.jsxs("div",{className:"exam-question-area",children:[e.jsxs("div",{className:"exam-q-header",children:[e.jsxs("span",{className:"exam-q-num",children:["문제 ",t+1]}),e.jsxs("span",{className:"exam-q-meta",children:[s.cat," · ",s.pts,"점"]})]}),e.jsx("p",{className:"exam-q-text",children:s.q}),s.schema&&e.jsxs("div",{className:"exam-schema",children:[e.jsx("h4",{children:"스키마 정보"}),e.jsx("pre",{children:s.schema})]}),s.sample&&e.jsxs("div",{className:"exam-schema",children:[e.jsx("h4",{children:"샘플 데이터"}),e.jsx("p",{children:s.sample})]}),s.type==="multiple"?e.jsx("div",{className:"exam-options",children:s.opts.map((a,h)=>{const E=a.charAt(0),M=a.substring(3);return e.jsxs("label",{className:`exam-option ${i[t]===E?"exam-option--sel":""}`,children:[e.jsx("input",{type:"radio",name:`q${t}`,checked:i[t]===E,onChange:()=>B(E)}),e.jsx("span",{className:"exam-option-num",children:"①②③④"[h]}),M]},E)})}):e.jsx("textarea",{className:`exam-textarea ${s.type==="sql"?"exam-textarea--sql":""}`,rows:s.type==="essay"?8:s.type==="sql"?6:3,placeholder:s.type==="sql"?"SQL 쿼리를 입력하세요...":"답안을 입력하세요...",value:i[t]||"",onChange:a=>B(a.target.value)}),e.jsxs("div",{className:"exam-controls",children:[e.jsx("button",{className:"exam-ctrl-btn",disabled:t===0,onClick:()=>o(t-1),children:"이전"}),t<c.length-1?e.jsx("button",{className:"exam-ctrl-btn exam-ctrl-btn--next",onClick:()=>o(t+1),children:"다음"}):e.jsx("button",{className:"exam-ctrl-btn exam-ctrl-btn--submit",onClick:()=>S(!0),children:"제출"})]})]}),e.jsx("div",{className:"exam-guide-area",children:e.jsxs("div",{className:"exam-guide-panel",children:[e.jsx("h4",{children:"📖 학습 가이드"}),s.guide?e.jsx("div",{className:"exam-guide-content",children:e.jsx("pre",{children:s.guide})}):e.jsx("p",{className:"exam-guide-empty",children:"이 문제에 대한 가이드가 없습니다."})]})})]}),U&&e.jsx("div",{className:"exam-modal-overlay",onClick:()=>S(!1),children:e.jsxs("div",{className:"exam-modal",onClick:a=>a.stopPropagation(),children:[e.jsx("h3",{children:"시험 제출 확인"}),e.jsxs("div",{className:"exam-modal-stats",children:[e.jsxs("p",{children:["답변: ",e.jsx("strong",{children:C()})," / ",c.length]}),e.jsxs("p",{children:["미답변: ",e.jsx("strong",{style:{color:"var(--warning-color,#f59e0b)"},children:c.length-C()}),"개"]})]}),e.jsx("p",{className:"exam-modal-warn",children:"제출 후에는 답안을 수정할 수 없습니다."}),e.jsxs("div",{className:"exam-modal-actions",children:[e.jsx("button",{className:"exam-ctrl-btn exam-ctrl-btn--submit",onClick:q,children:"제출"}),e.jsx("button",{className:"exam-ctrl-btn",onClick:()=>S(!1),children:"취소"})]})]})})]})})]})}const{total:p,cats:k,details:g,student:W,time:Q}=w,P=p>=90?"A":p>=80?"B":p>=70?"C":p>=60?"D":"F",R=p>=90?"#22c55e":p>=80?"#3b82f6":p>=70?"#f59e0b":"#ef4444";return e.jsxs(e.Fragment,{children:[e.jsx("section",{className:"page-header",children:e.jsxs("div",{className:"container",children:[e.jsx("h1",{children:"시험 결과"}),e.jsxs("p",{children:[W,"님의 초급테스트 결과입니다"]})]})}),e.jsx("section",{className:"section",children:e.jsxs("div",{className:"container",children:[e.jsxs("div",{className:"exam-result-summary","data-aos":"fade-up",children:[e.jsxs("div",{className:"exam-score-circle",style:{borderColor:R},children:[e.jsx("span",{className:"exam-score-num",style:{color:R},children:p}),e.jsx("span",{className:"exam-score-label",children:"/ 100"})]}),e.jsxs("div",{className:"exam-score-info",children:[e.jsxs("span",{className:"exam-grade",style:{background:R},children:[P,"등급"]}),e.jsxs("span",{children:["소요시간: ",f(Q)]}),e.jsxs("span",{children:["정답률: ",Math.round(g.filter(s=>s.score===s.pts).length/c.length*100),"%"]})]})]}),e.jsx("div",{className:"exam-cat-scores","data-aos":"fade-up","data-aos-delay":"100",children:Object.entries(k).map(([s,{s:l,t:N}])=>e.jsxs("div",{className:"exam-cat-bar",children:[e.jsxs("div",{className:"exam-cat-label",children:[e.jsx("strong",{children:s}),e.jsxs("span",{children:[l," / ",N]})]}),e.jsx("div",{className:"exam-bar-track",children:e.jsx("div",{className:"exam-bar-fill",style:{width:`${l/N*100}%`,background:R}})})]},s))}),e.jsx("div",{className:"exam-result-tabs","data-aos":"fade-up","data-aos-delay":"150",children:H.map(s=>e.jsxs("button",{className:`exam-tab-btn ${b===s?"exam-tab-btn--active":""}`,onClick:()=>v(s),children:[s," (",g.filter(l=>l.cat===s).length,")"]},s))}),e.jsx("div",{className:"exam-detail-list",children:g.filter(s=>s.cat===b).map(s=>e.jsxs("details",{className:`exam-detail-item ${s.score===s.pts?"exam-detail--ok":s.score>0?"exam-detail--partial":"exam-detail--wrong"}`,children:[e.jsxs("summary",{children:[e.jsxs("span",{className:"exam-detail-num",children:["Q",s.id]}),e.jsx("span",{className:"exam-detail-q",children:s.q.length>60?s.q.slice(0,60)+"...":s.q}),e.jsxs("span",{className:"exam-detail-score",children:[s.score,"/",s.pts]})]}),e.jsxs("div",{className:"exam-detail-body",children:[e.jsx("p",{children:e.jsx("strong",{children:"내 답안:"})}),e.jsx("pre",{className:"exam-detail-ans",children:s.userAns||"(미답변)"}),e.jsx("p",{children:e.jsx("strong",{children:"정답:"})}),e.jsx("pre",{className:"exam-detail-ans exam-detail-correct",children:s.ans}),s.exp&&e.jsxs("div",{className:"exam-explanation",children:[e.jsx("strong",{children:"해설:"})," ",s.exp]})]})]},s.id))}),e.jsxs("div",{className:"exam-result-actions","data-aos":"fade-up",children:[e.jsx("button",{className:"exam-ctrl-btn exam-ctrl-btn--next",onClick:F,children:"다시 풀기"}),e.jsx("button",{className:"exam-ctrl-btn",onClick:()=>window.print(),children:"인쇄"})]})]})})]})};export{Y as default};
