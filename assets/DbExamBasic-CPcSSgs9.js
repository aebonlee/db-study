import{r,j as e}from"./index-C6Ztfr-z.js";import{u as V}from"./useAOS-Cy3puzSI.js";const l=[{id:1,type:"multiple",cat:"A형",pts:2,q:"다음 중 DBMS 필수 기능이 아닌 것은?",opts:["A. 정의","B. 조작","C. 제어","D. 연산"],ans:"D",exp:"DBMS의 3대 기능은 정의(DDL), 조작(DML), 제어(DCL)입니다. 연산은 별도 기능이 아닙니다.",guide:`DBMS 3대 기능:
